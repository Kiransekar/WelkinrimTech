        ...
        <div className="md:col-span-1">
          ...
          <div className="flex gap-3">
            {["in", "tw", "yt"].map((soc) => (
              <div
                key={soc}
                className="w-8 h-8 border border-white/10 hover:border-[#FFCC00] hover:text-[#FFCC00] flex items-center justify-center text-white/50 text-xs cursor-pointer transition-all duration-200"
          ...
          <nav className="flex flex-col gap-3">
            {navLinks.map((link) => (
              <button
                ...
                className="text-left text-xs text-white/60 hover:text-[#FFCC00] transition-colors duration-200 uppercase tracking-widest"
                style={{ fontFamily: 'Michroma, sans-serif' }}
              >
                {link.label}
              </button>
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1">
            <div className="h-px w-8 bg-[#FFCC00]/40" />
            <span className="text-[10px] text-[#FFCC00]/60 uppercase tracking-widest px-2" style={{ fontFamily: 'Michroma, sans-serif' }}>
