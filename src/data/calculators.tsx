...
export const CALCULATORS: CalculatorConfig[] = [
  ...
  {
    id: "awgswg",
    label: "AWG SWG Conversion",
    tag: "Wire Gauge",
    description: "Convert between AWG and SWG standards. View diameter, cross-section area, and resistance comparison.",
    status: "live",
    accent: "#ffc812",
    textColor: "#000",
    category: "industrial",
    metrics: ["AWG", "SWG", "Diameter", "Resistance"],
    icon: FaviconIcon,
    inputCount: 2,
    outputCount: 6,
  },
  {
    ...
    label: "CgCalc",
    tag: "Airplane",
    description: "Center of Gravity and Neutral Point calculator. Ensure optimal stability for RC and UAV aircraft.",
    status: "live",
    accent: "#ffc812",
    textColor: "#000",
    category: "airplane",
    metrics: ["CG Position", "Neutral Point", "MAC", "Static Margin"],
    icon: FaviconIcon,
    inputCount: 12,
    outputCount: 8,
  },
